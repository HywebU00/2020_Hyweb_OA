      ...
      g = (function () {
        ...
        e.prototype.close = function () {
          ...
          if (
            this.isOpen &&
            this.browserProps &&
            f.container.ownerDocument instanceof Document
          )
            f.container.ownerDocument[this.browserProps.exitFullscreen]();
        ...
        e.prototype.open = function () {
          var f = this,
            e = f.chart;
          if (f.browserProps) {
            f.unbindFullscreenEvent = k(
              e.container.ownerDocument,
              f.browserProps.fullscreenChange,
              function () {
                f.isOpen
                  ? ((f.isOpen = !1), f.close())
                  : ((f.isOpen = !0), f.setButtonText());
              }
            );
        ...
        e.prototype.setButtonText = function () {
          var f,
            ...
            l =
              null === (f = null === k || void 0 === k ? void 0 : k.buttons) ||
              void 0 === f
                ? void 0
                : f.contextButton.menuItems;
          f = e.options.lang;
          (null === k || void 0 === k ? 0 : k.menuItemDefinitions) &&
            ...
            g &&
            g.length &&
            (g[l.indexOf("viewFullscreen")].innerHTML = this.isOpen
              ? f.exitFullscreen
              : k.menuItemDefinitions.viewFullscreen.text || f.viewFullscreen);
        };
    ...
    function (e, l, g, k, q, f) {
      ...
      g.isSafari &&
        g.win.matchMedia("print").addListener(function (a) {
          g.printingChart &&
            (a.matches
              ? g.printingChart.beforePrint()
              : g.printingChart.afterPrint());
        });
      z(e.prototype, {
        ...
        getSVG: function (a) {
          ...
          this.axes.forEach(function (a) {
            ...
            d = d.userMax;
            b &&
              (("undefined" !== typeof c && c !== b.min) ||
                ("undefined" !== typeof d && d !== b.max)) &&
              b.setExtremes(c, d, !0, !1);
          });
          f = g.getChartHTML();
          C(this, "getSVG", {
            chartCopy: g,
        ...
        contextMenu: function (a, b, c, d, e, g, k) {
          ...
          if (!m) {
            ...
            b.forEach(function (a) {
              "string" === typeof a &&
                (a = h.options.exporting.menuItemDefinitions[a]);
              if (J(a, !0)) {
                if (a.separator) var b = x("hr", null, null, p);
                else
                  "viewData" === a.textKey &&
                    h.isDataTableVisible &&
                    (a.textKey = "hideData"),
                    (b = x(
                      "li",
                      {
          ...
          c + h.exportMenuWidth > l
            ? (b.right = l - c - e - u + "px")
            : (b.left = c - u + "px");
          d + g + h.exportMenuHeight > B &&
        ...
        addButton: function (a) {
          ...
          if (!1 !== d.enabled) {
            ...
            var B;
            b.styledMode ||
              ((h.fill = t(h.fill, "#ffffff")),
              (h.stroke = t(h.stroke, "none")));
            delete h.states;
            e
              ? (B = function (a) {
                  a && a.stopPropagation();
            ...
            d.text && d.symbol
              ? (h.paddingLeft = t(h.paddingLeft, 25))
              : d.text ||
                z(h, {
                  width: d.width,
                  height: d.height,
            ...
            if (d.symbol) {
              var m = c
                .symbol(d.symbol, d.symbolX - g / 2, d.symbolY - g / 2, g, g, {
                  width: g,
                  height: g,
                })
            ...
            b.buttonOffset +=
              (n.width + d.buttonSpacing) * ("right" === d.align ? -1 : 1);
        ...
        destroyExport: function (a) {
          ...
          c &&
            (c.forEach(function (a, d) {
              ...
              b.exportDivElements[
                d
              ] = a.onmouseout = a.onmouseover = a.ontouchstart = a.onclick = null;
              D(a);
            }),
            (c.length = 0));
          d &&
      ...
      e.prototype.inlineStyles = function () {
        ...
        function b(c) {
          function n(b, g) {
            ...
            for (r = e.length; r-- && !u; )
              u = e[r].test(g) || "function" === typeof b;
            u ||
              (w[g] === b && "svg" !== c.nodeName) ||
              h[c.nodeName][g] === b ||
              (d && -1 === d.indexOf(g)
                ? (m += a(g) + ":" + b + ";")
                : b && c.setAttribute(a(g), b));
          }
          var m = "",
            u,
            q,
          ...
          if (1 === c.nodeType && -1 === g.indexOf(c.nodeName)) {
            ...
            var w =
              "svg" === c.nodeName
                ? {}
                : y.getComputedStyle(c.parentNode, null);
            if (!h[c.nodeName]) {
