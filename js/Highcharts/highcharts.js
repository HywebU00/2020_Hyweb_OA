...
(function (X, N) {
    ...
    function (f, h, m, z) {
      ...
      I(m.prototype, {
        ...
        html: function (f, D, n) {
          ...
          l.xSetter = l.ySetter = l.alignSetter = l.rotationSetter = function (
            d,
            c
          ) {
  ...
  N(
    ...
    function (f, h, m, z) {
      ...
      ("");
      f.defaultOptions = {
        colors: "#f7a35c #7cb5ec #FB5B29 #90ed7d #f7a35c #8085e9 #f15c80 #e4d354 #2b908f #f45b5b #91e8e1".split(
          " "
        ),
        ...
        tooltip: {
          ...
          snap: F ? 25 : 10,
          headerFormat:
            '<div class="highcharts-tip__header" ><span class="highcharts-tip__title" style="font-size:18px;">{point.key}</span><br/></div>',
          // '<span class="highcharts-tip__title" style="font-size:18px;">{point.key}</span><br/>',
          pointFormat:
            '<span style="color:{point.color}">\u25cf</span> {series.name}: <b>{point.y}</b><br/>',
          //backgroundColor: h("#f7f7f7").setOpacity(0.85).get(),
          backgroundColor: h("#ffffff").setOpacity(0.8).get(),
          borderWidth: 1,
          shadow: !0,
          style: {
            color: "#333333",
      ...
      f = (function () {
        ...
        u.prototype.destroy = function (b) {
          ...
          for (d in a.plotLinesAndBandsGroups)
            a.plotLinesAndBandsGroups[d] = a.plotLinesAndBandsGroups[
              d
            ].destroy();
          B(a, function (b, c) {
        ...
        r.prototype.getLabel = function () {
          ...
          if (!this.label) {
            this.outside &&
              ...
              (this.renderer = a = new f.Renderer(
                r,
                0,
                0,
    ...
    function (f, h, m, z) {
      ...
      f = (function () {
        ...
        g.prototype.setHoverChartIndex = function () {
          ...
          if (a && a !== c)
            a.pointer.onContainerMouseLeave({
              relatedTarget: !0,
            });
      ...
      var r = h.marginNames,
        ...
        g = (function () {
          ...
          c.prototype.handleOverflow = function (a) {
            ...
            t.length = 0;
            a > f && !1 !== v.enabled
              ? ((this.clipHeight = h = Math.max(
                  f - 20 - this.titleHeight - l,
                  0
                )),
      ...
      L(h, "afterSetChartSize", function (f) {
        ...
        if (!this.renderer.forExport) {
          if (h) {
            ...
            e &&
              (this.scrollablePixelsY = h = Math.max(
                0,
                e - this.chartHeight
              )) &&
              ((this.plotHeight += h),
      ...
      h.prototype.applyFixed = function () {
        ...
        h
          ? ((this.fixedDiv = K(
            ...
            (this.fixedRenderer = f = new m.Renderer(
              this.fixedDiv,
              this.chartWidth,
              this.chartHeight,
        ...
        },
        {
          ...
          getGraphPath: function (e) {
            ...
            for (n = 0; n < e.length; n++) {
              m ||
                (e[n].leftCliff = e[n].rightCliff = e[n].leftNull = e[
                  n
                ].rightNull = void 0);
              var a = e[n].isNull;
              ...
              if (D(h.plotY) && null !== h.y) {
                ...
                e.enabledDataSorting &&
                  (h.startXPos = e.xAxis.reversed
                    ...
                    : e.xAxis.width);
                p ||
                  ((h.graphic = p = g[h.shapeType](a).add(
                    h.group || e.group
                  )) &&
                    e.enabledDataSorting &&
                    f.hasRendered &&
              ...
              if (a && p) {
                ...
                if (v)
                  if (m)
                    ...
                    e &&
                      ((d.stateMarkerGraphic = m = k.renderer
      ...
      l(F.prototype, {
        ...
        setVisible: function (a, c) {
          var d = this,
            ...
            h = d.visible;
          var l = (d.visible = a = d.options.visible = d.userOptions.visible =
