  ...
  g(
    ...
    function (a, b, e, c, g) {
      function v(a, b) {
        var d = n.navigator,
          f =
            -1 < d.userAgent.indexOf("WebKit") &&
            0 > d.userAgent.indexOf("Chrome"),
      ...
      b.prototype.setUpKeyToAxis = function () {
        f.arearange &&
          (f.arearange.prototype.keyToAxis = {
            low: "y",
            high: "y",
          });
        f.gantt &&
          (f.gantt.prototype.keyToAxis = {
            start: "x",
            end: "x",
          });
      };
      b.prototype.getDataRows = function (d) {
        ...
        this.series.forEach(function (a) {
          ...
          if (
            ...
            for (q = 0; q < m; )
              (t = H(a, k[q], k.length)),
                E.push(t.columnTitle || t),
                d && n.push(t.topLevelColumnTitle || t),
                q++;
            var u = {
              chart: a.chart,
            ...
            a.options.data.forEach(function (d, h) {
              ...
              q = 0;
              if (!y || "name" === a.exportKey || (!b && y && y.hasNames && e))
                d = e;
              g && (g[d] && (d += "|" + h), (g[d] = !0));
              r[d] || ((r[d] = []), (r[d].xValues = []));
              r[d].x = z.x;
              r[d].name = e;
              for (r[d].xValues[l] = z.x; q < m; )
                (h = k[q]),
                  (e = z[h]),
                  (r[d][A + q] = x(
                    w.categoryMap[h][e],
                    w.dateTimeValueAxisMap[h]
                      ? f.dateFormat(c.dateFormat, e)
                      : null,
                    e
                  )),
                  q++;
            ...
            B &&
              ...
              (B.dateTime
                ? (a.x instanceof Date && (a.x = a.x.getTime()),
                  (d = f.dateFormat(c.dateFormat, a.x)))
                : (d = B.categories
                    ? x(B.names[a.x], B.categories[a.x], a.x)
                    : a.x));
            a.splice(v, 0, d);
          });
        }
      ...
      b.prototype.getCSV = function (a) {
        ...
        b.forEach(function (a, c) {
          for (var m, w = a.length; w--; )
            (m = a[w]),
              "string" === typeof m && (m = '"' + m + '"'),
              "number" === typeof m &&
                "." !== f &&
                (m = m.toString().replace(".", f)),
              (a[w] = m);
          d += a.join(e);
          c < b.length - 1 && (d += g);
        });
      ...
      b.prototype.getTable = function (a) {
        ...
        a.forEach(function (a) {
          b += "<tr>";
          for (var d = 0; d < e; d++)
            b += p(d ? "td" : "th", null, d ? "" : 'scope="row"', a[d]);
          b += "</tr>";
        });
        b += "</tbody></table>";
        a = {
      ...
      b.prototype.viewData = function () {
        ...
        if (
          ...
          "none" === this.dataTableDiv.style.display
        )
      ...
      b.prototype.toggleDataTable = function () {
        ...
        (null === p || void 0 === p ? 0 : p.menuItemDefinitions) &&
          ...
          a &&
          a.length &&
          (a[b.indexOf("viewData")].innerHTML = this.isDataTableVisible
            ? c.hideData
            : c.viewData);
      };
      var p = L().exporting;
